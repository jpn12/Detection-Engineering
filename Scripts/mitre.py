                ...
                if 'external_id' in reference:
                    if((reference['external_id'].startswith("T"))):
                        ...
                        if 'x_mitre_deprecated' in object:
                            ...
                            filtered_object = {'tactic': str(tactics), 'technique': technique, 'name': name, 'url': url, 'deprecated': deprecated}
                            mitreMapped[technique] = filtered_object
                        else:
                            filtered_object = {'tactic': str(tactics), 'technique': technique, 'name': name, 'url': url, 'deprecated': "False"}
                            mitreMapped[technique] = filtered_object
